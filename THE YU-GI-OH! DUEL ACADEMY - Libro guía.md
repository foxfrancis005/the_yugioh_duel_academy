...
* **Propietario**: jugador al que pertenece originalmente la carta fuente.
* **Controlador**: jugador que actualmente controla una carta en el Campo.
...
#### Dimensión de propiedad por defecto

Cuando una zona, carta o elemento del juego sea mencionado sin especificar explícitamente una dimensión de propiedad, se asume que pertenece al **propietario de la carta fuente**. Cualquier dimensión explícitamente declarada prevalece sobre este valor por defecto. Por ejemplo, "desde el Deck" se interpreta como "desde el Deck del propietario de la carta fuente".
...
## - Finalización: La cadena se disuelve
